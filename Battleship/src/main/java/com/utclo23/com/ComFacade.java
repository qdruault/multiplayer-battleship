...
public class ComFacade {
    ...
    * @param dest is the player who must receive the ships coordinates
    */
    ...
    * @param user is the user who starts the sendDiscovery
    ...
    */
    ...
    /**
    * Called to send a request to get detailed information of a specified 
    * user.
    ...
    */
    ...
    /**
    * If success, send a 'join game' notification to everybody with the 
    * player who joined the game. Otherwise, the player who wanted to join the 
    * game is advertised that it failed.
